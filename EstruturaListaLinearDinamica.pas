...
type
  ...
  public
    ...
    { carrega em texto as informações de todos os alunos - iniciando pelo primeiro Nó }
    function carregarAlunos: TStrings;
    { carrega em texto as informações de todos os alunos - iniciando pelo último Nó }
    function carregarAlunoPeloUltimoNo: TStrings;

    { retorna o Nó se encontrado pela numero da matricula }
